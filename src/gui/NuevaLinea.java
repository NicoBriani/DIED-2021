...
public class NuevaLinea extends JFrame {
	...
	public NuevaLinea() {
		...
		btnAceptar.addActionListener(e -> {
			if (!textNombre.getText().isEmpty() && !textColor.getText().isEmpty()) {
				...
				linea.setNombre(textNombre.getText());
				linea.setColor(textColor.getText());
				linea.setEstado(comboBoxEstado.getSelectedItem().toString());
